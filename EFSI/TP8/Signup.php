    ...
    ?>
        ...
        <div class=" row">
            ...
            <div class="col-md-3 pl-4">
                <form action="processSignup.php" method="POST" class="bg-white ml-4 h-100">
                    <div class="text-center">
                     <h4>Registrate</h4> <hr><br>
                    </div>
                    ...
                    <input type="email" id="Email" name="email" class="md-4 form-control"><br>
                    <label for="clave"> Contraseña</label><br>
                    <input type="password" id="clave" name="password" class="md-4 form-control"><br> <hr>
                    <input type="submit" class="btn btn-success col-md-12  mb-4" value="Registrate" /> <br>
                    <label>¿Ya tienes cuenta ?</label> <a href="Login.php">Inicia Sesión!</a><hr>
